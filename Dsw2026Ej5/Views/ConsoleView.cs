...
public class ConsoleView
{
    ...
    private static void ListarVehiculos()
    {
        ...
        DibujarLinea();
        Console.WriteLine($"Total consumo Vehículos Eléctricos: {totalConsumos.Item1.ToString("F2")} kWh");
        Console.WriteLine($"Total consumo Vehículos Combustible: {totalConsumos.Item2.ToString("F2")} Litros");
        DibujarLinea();
        Console.Write("\n");
        Console.Write("\n");
